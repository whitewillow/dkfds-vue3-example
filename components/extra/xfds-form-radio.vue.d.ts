...
declare const _default: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "readonly" | "label" | "hint" | "disabled" | "id" | "modelValue" | "options" | "inputType" | "placeholder" | "autocomplete" | "inputClass" | "validations" | "tooltip">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
